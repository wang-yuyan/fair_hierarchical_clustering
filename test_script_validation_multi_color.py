...
from helper_functions import find_maximal_clusters, calculate_distance, calculate_balance_clusters_multi_color, calculate_hc_obj,condense_dist, avlk_with_fairlets_multi_color, subsample_multi_color
from eps_local_opt_fairlet_multi_color import load_data_with_multi_color, find_eps_local_opt_random_multi_color, random_fairlet_decompose_multi_color, calculate_obj_multi_color
...
def test(filename, num_list, color_types, alpha, output_direc, num_instances, rho):
    ...
    for num in num_list:
        ...
        for i in range(num_instances):
            ...
            scipy_maximal_cluster = find_maximal_clusters(scipy_root, 2 * alpha)
            scipy_root_balance = calculate_balance_clusters_multi_color(scipy_maximal_cluster, color_nums)
            ...
            random_root = avlk_with_fairlets_multi_color(dist, random_fairlets)
            random_obj, _ = calculate_hc_obj(dist, random_root)
